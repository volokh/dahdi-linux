 ...
 *
 * $Id: ds21554.h,v 1.8 2008-02-15 15:03:18 ly Exp $
 */
...
#define CCR2_RFF	0x02	/* receive force freeze */
#define CCR2_RFE	0x01	/* receive freeze enable */
...
#define CCR3_TIRFS	0x20	/* TIRs define data channels from RSER pin */
#define CCR3_4		0x10	/* not assigned */
#define CCR3_RSRE	0x08	/* receive side re-insertion enables */
#define CCR3_THSE	0x04	/* insert signaling from TSIG into TSER */
#define CCR3_TBCS	0x02	/* transmit backplane clock 2048 */
#define CCR3_RCLA	0x01	/* carrier loss criteria: 0 = 255 zeros, 1 = 2048 zeros */
...
#define LICR_JA_RX	0x00	/* receive side jitter attenuator select */
...
#define RIR_RES_FULL	0x10	/* elastic store full */
#define RIR_RES_EMPTY	0x08	/* elastic store empty */
#define RIR_RESYNC_CRC	0x04	/* CRC4 resync (915/1000 errors) */
#define RIR_RESYNC_FAS	0x02	/* frame resync (three consec errors) */
...
#define SSR_SYNC_FAS	0x04	/* frame alignment sync active */
...
#define DS_TCC		0xa0	/* rw - transmit channel control 1..4 */
#define DS_TC		0x60	/* rw - transmit channel control 1..32 */
#define DS_RCC		0xa4	/* rw - receive channel control 1..4 */
#define DS_RC		0x80	/* rw - transmit channel control 1..32 */
...
#define CCR5_RESA	0x40	/* receive elastic store align */
#define CCR5_TESA	0x20	/* transmit elastic store align */
